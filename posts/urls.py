...
from .views import LetterView, AnswerView, ListAllPostsView, DetailLetterView, DetailAnswerView, QuestionDetailView
...
urlpatterns = [
    ...
    path('question/<str:date>/', QuestionDetailView.as_view(), name='question_detail'),
]